...
<head>
  ...
  <title><fmt:message bundle="${i18n}" key="recuperar.title"/></title>
  ...
  <link rel="stylesheet" href="CSS/Recuperar_ContraseñaCSS.css" />
...
<body>
  ...
  <div class="page-wrapper">
    ...
    <div class="card">
      ...
      <div class="card-header">
        ...
        <h2><fmt:message bundle="${i18n}" key="recuperar.header.titulo"/></h2>
        <p><fmt:message bundle="${i18n}" key="recuperar.header.subtitulo"/></p>
      </div>
      ...
      <form id="recoveryForm" novalidate>
        ...
        <div class="form-group">
          <label for="email"><fmt:message bundle="${i18n}" key="recuperar.form.correo"/></label>
        ...
        <button id="submitBtn" type="submit" class="btn-submit" style="margin-top:8px">
          ...
          <span class="material-symbols-outlined btn-arrow">send</span>
        </button>
      ...
      <a class="back-link" href="Inicio_de_sesion.jsp">
        <span class="material-symbols-outlined">arrow_back</span>
        <fmt:message bundle="${i18n}" key="recuperar.link.volverLogin"/>
      </a>
    ...
    <div class="footer-links">
      <a href="#"><fmt:message bundle="${i18n}" key="recuperar.footer.privacidad"/></a>
      <a href="#"><fmt:message bundle="${i18n}" key="recuperar.footer.terminos"/></a>
      <a href="#"><fmt:message bundle="${i18n}" key="recuperar.footer.soporte"/></a>
    </div>
  ...
  <div id="toast" class="toast" role="alert" aria-live="polite">
    <span class="material-symbols-outlined t-icon">check_circle</span>
  ...
  <script src="JS/Recuperar_ContraseñaJS.js"></script>
