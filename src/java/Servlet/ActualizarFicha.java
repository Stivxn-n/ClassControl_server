...
@WebServlet("/ActualizarFicha")
public class ActualizarFicha extends ActualizarBaseServlet {
    ...
    protected boolean actualizar(HttpServletRequest request) {
        ...
        ficha.setId_ficha(entero(request, "id"));
        ...
        return new FichaDAO().actualizarFicha(ficha);
    }
}
